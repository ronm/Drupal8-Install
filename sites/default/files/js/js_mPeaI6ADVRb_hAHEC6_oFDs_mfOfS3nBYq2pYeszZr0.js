...
(function(window, document) {
	...
	window.smoothScroll = function(elem, options) { 
		...
		//scrollObj.destination = destination === 0 ? destination : Math.ceil( destination - ( document.body.clientWidth >= 1025 ? 86 : header.getBoundingClientRect().height ));
		//scrollObj.destination = destination === 0 ? destination : Math.ceil( destination - ( header.getBoundingClientRect().height ));
